...
func (dao *QuestionnaireDao_) CountQuestionnaire(publisherId uint32) (int64, error) {
	var count int64
	count = 0
	result := dao.db.Model(&Questionnaire{}).Where("publisher_id = ?", publisherId).Count(&count)
